...
export default function SKKCouponReport() {
  const [data] = useState(mockCouponReport)
  ...
  return (
    <ReportLayout
      ...
      description="รายงานสรุปการจ่ายคูปองและสถานะการใช้งาน"
      icon={Ticket}
    >
      {/* Filter */}
      <ReportFilter 
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <Thead>
              <Tr>
                <Th colSpan={16} className="text-center text-xl font-bold py-4">รายงานการจ่ายคูปอง</Th>
              </Tr>
              <Tr isHeader>
                ...
                <Th rowSpan={2} className="w-28 text-center align-middle border">เลขที่คูปอง</Th>
                ...
                <Th rowSpan={2} className="w-24 text-center align-middle border">สถานะ</Th>
              </Tr>
              <Tr isHeader>
            ...
            <Tbody>
              {data.map((item) => (
                <Tr key={item.id}>
                  ...
                  <Td className="text-center border">{item.couponNo}</Td>
