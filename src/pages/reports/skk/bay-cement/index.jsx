...
export default function SKKBayCementReport() {
  const [data] = useState(mockBayCementReport)
  ...
  return (
    <ReportLayout
      ...
      description="รายงานสรุปการจ่ายปูนในแต่ละรางจ่าย"
      icon={Truck}
    >
      {/* Filter */}
      <ReportFilter 
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <Thead>
              <Tr>
                <Th colSpan={15} className="text-center text-xl font-bold py-4">รายงานการจ่ายปูนในรางจ่าย</Th>
              </Tr>
              <Tr isHeader>
                ...
                <Th rowSpan={2} className="w-24 text-center align-middle border">จำนวนเที่ยว</Th>
            ...
            <Tbody>
              {data.map((item) => (
                <Tr key={item.id}>
                  ...
                  <Td className="text-center border">{item.deliveryCount}</Td>
            ...
            <Tfoot>
              <Tr>
                <Td colSpan={4} className="text-center font-semibold border">รวมทั้งหมด</Td>
                ...
                <Td className="text-center font-semibold border">{data.reduce((sum, item) => sum + item.deliveryCount, 0)}</Td>
