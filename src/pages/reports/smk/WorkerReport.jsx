...
export default function SMKWorkerReport() {
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <Thead>
              <Tr>
                <Th colSpan={19} className="text-center text-xl font-bold py-4">รายงานคนยก</Th>
              </Tr>
              <Tr isHeader>
                ...
                <Th colSpan={2} className="text-center border">Clamp</Th>
